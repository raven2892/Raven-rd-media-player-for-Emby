...
Raven rd 使用或集成了以下第三方开源项目、系统组件和开发工具：
...
- 除明确标注为第三方内容的部分外，Raven 的原创程序代码、界面设计、文档、配置、脚本及其他原创内容的著作权归 Raven rd 所有。
- 未经授权，不得复制、修改、重新打包、重新发布或以其他方式将 Raven 冒充为官方版本进行分发，也不得未经许可使用 Raven 的名称、标识、界面资源或其他原创内容制作具有误导性的衍生版本。
